...
\subsubsection{Triplet Ranking Loss}\label{ch:ID,sec:SNNDevelopment,sub:lossFunction,subsub:Triplet}
...
\subsection{Semi-Hard Triplet Mining}\label{ch:ID,sec:SNNDevelopment,sub:SemiHardTripletMining}
...
\subsection{Class Prototyping}\label{ch:ID,sec:SNNDevelopment,sub:prototypes}
