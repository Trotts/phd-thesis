...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.6]{Chapter5/figs/crop-with-unclassified-noise-updated.png}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.8\linewidth]{Chapter5/figs/signet-SNN-architecture.png}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.5]{Chapter5/figs/pairwise_ranking_loss_faces-updated.png}
	\end{center}
...
Triplet Ranking Loss aims to avoid this issue by training on triplets of data points rather than pairs, with each triplet containing an Anchor, a Positive, and a Negative. SNNs which make use of Triplet Ranking Loss are often named Triplet Networks in the literature (such as in Hoffer \textit{et al.} \cite{hoffer_deep_2018}), however the only difference between the structure of an SNN using Pairwise Ranking Loss or Triplet Ranking Loss is the number of branches -- two or three respectively. 

\begin{figure}
	\begin{center}
		\includegraphics[scale=0.5]{Chapter5/figs/triplet-loss-eg-updated.png}
	\end{center}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=\linewidth]{Chapter5/figs/uncatalogued-individual-example-ndd-au-smru-updated.png}
	\end{center}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=\linewidth]{Chapter5/figs/noise-example-ndd-au-smru-updated.png}
	\end{center}
