...
Whilst this work compliments and expands upon work in the areas of animal re-identification \cite{vetrova_hidden_2018, clapham_automated_2020, birenbaum_sealnet_2022}, limitations to the approach do exist as outlined in Section \ref{ch:ID,sec:ModelSelection,sub:limitations}. Chapter \ref{ch:IDEval} aims to address and contextualise some of these limitations by evaluating the SNN approach to most likely matching using a second real-life photo-id catalogue. This will allow for an in-depth examination into whether the approach generalises well, and if the uncatalogued individual distance threshold is catalogue dependant. 


% Sec: Conclusion
% Summary of the work
% How does the best model meet the requirements? 
...
% Some limitations discussed in Ch 6 using different dataset (model retraining, uncatalogued thresholding, etc)
