...
% Sec: SNN Evaluation
% Limitations - Thresholding values may be catalogue dependant, requires the researcher to play around with the value when training a new catalogue (add into first para?)
% Might not work for other cetacean species, catalogues are well protected. 
