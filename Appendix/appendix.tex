...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{Class labels for the images shown in Figure \ref{fig:above-water-example}. Table ordering is consistent with that of the Figure, viewing left to right.}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabular}{cccc}\toprule
		...
		\bottomrule
	\end{tabular}
	\caption{Class labels for the images shown in Figure \ref{fig:below-water-example}. Table ordering is consistent with that of the Figure, viewing left to right.}
\end{table}
...
\begin{table}[!ht]
	...
	\resizebox{!}{.55\height}{
		...
		\begin{tabular}{ccccccccccccc}
			...
			\bottomrule                                                      
	\end{tabular}}
	\caption{Optimal SNN hyperparameters for the best performing SNN trained on the per-side NDD AU SMRU dataset located using Bayesian optimisation over 100 iterations. Results given to 3 decimal places where applicable. See Section \ref{ch:ID,sec:perSide}}
\end{table}
