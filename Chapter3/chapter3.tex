...
\begin{table}[!ht]
	\centering
		\begin{tabular}{cccc}
			...
			\multicolumn{1}{c}{}                                     & \textbf{0.50}  & \textbf{0.75} & \textbf{0.85} \\ \midrule
			\textbf{20190902T0946}                                   & \textbf{0.914} & \textbf{0.793} & \textbf{0.497} \\
			20190905T1813                                            & 0.937          & 0.775          & 0.452          \\
			20190907T0934                                            & 0.921          & 0.796          & 0.457          \\
			20190907T2215                                            & 0.928          & 0.789          & 0.452          \\
			20190908T2043                                            & 0.929          & 0.804          & 0.482          \\
			20190912T0608                                            & 0.910          & 0.771          & 0.463          \\
			20191102T0140                                            & 0.916          & 0.813          & 0.442          \\
			20191102T1051                                            & 0.914          & 0.812          & 0.461          \\
			20191103T0959                                            & 0.929          & 0.766          & 0.437          \\
			20191103T1921                                            & 0.926          & 0.768          & 0.360          \\
			\bottomrule
		\end{tabular}
	\caption[mAP@IOU{[}0.5, 0.75, 0.85{]} scores for the ten best performing Mask R-CNN models trained on the Zanzibar dataset.]{mAP@IOU{[}0.5, 0.75, 0.85{]} scores for the best performing Mask R-CNN models trained on the Zanzibar dataset. The model chosen for use is highlighted in bold. Subset of Table \ref{tab:MaskRCNNHyperparamTuningGridSearch}.}
...
\begin{table}[!ht]
	...
	\begin{adjustbox}{width=\columnwidth, center}
		\begin{tabular}{cccccc}
			...
			\midrule
				\textbf{20190902T0946} &         $\mathbf{1\times10^{-2}}$ &  \textbf{ (16, 32, 64, 128, 256)} &      \textbf{SGDR} &                  \textbf{aug1} &                  \textbf{\cmark} \\
				20190905T1813 &        $1\times10^{-3}$ &  (32, 64, 128, 256, 512) &      SGDR &                  aug1 &                  \cmark \\
				20190907T0934 &         $1\times10^{-2}$ &  (32, 64, 128, 256, 512) &      SGDR &                  None &                  \cmark \\
				20190907T2215 &        $1\times10^{-3}$ &   (16, 32, 64, 128, 256) &      SGDR &                  aug2 &                  \cmark \\
				20190908T2043 &       $1\times10^{-4}$ &  (32, 64, 128, 256, 512) &      SGDR &                  aug1 &                  \cmark \\
				20190912T0608 &       $1\times10^{-4}$ &   (16, 32, 64, 128, 256) &      SGDR &                  aug1 &                  \cmark \\
				20191102T0140 &         $1\times10^{-2}$ &  (32, 64, 128, 256, 512) &      SGDR &                  aug1 &                  \cmark \\
				20191102T1051 &       $1\times10^{-4}$ &   (16, 32, 64, 128, 256) &      SGDR &                  None &                  \cmark \\
				20191103T0959 &         $1\times10^{-2}$ &  (32, 64, 128, 256, 512) &      SGDR &                  aug2 &                  \cmark \\
				20191103T1921 &       $1\times10^{-4}$ &   (16, 32, 64, 128, 256) &      SGDR &                  aug2 &                  \cmark \\
			\bottomrule
		\end{tabular}
	\end{adjustbox}
