...
% Add in figures showing colout thresholding. Show that by using thresholding the flag is discarded but the other two fins are kept. Find an over/under exposed fin and show that at 90% the fin would be discarded but at 50% the fin is kept. Find noise which is kept even after thresholding. 
