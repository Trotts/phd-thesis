...
% Chapter Summary
% Creation of a NDD20. Shown the model created previously is invariant to changes in geo, time, species. Baseline results for below water. 
% Highlight use of NDD20, Kaggle comp.
% Processed into a form ready for individual ID, Segmented NDD20  + NDD AU SMRU. Table comparing the two datasets. 
