...
\begin{enumerate}
	\item Is coarse-grain detection of highly variant regions of interest (RoI) in large-scale, noisy, above water photo-id imagery possible with high levels of accuracy? 
